...
def _setup_startup_view():
    ...
    view[4].shading.type = "RENDERED"
    bpy.app.timers.register(_fullscreen_startup_view, first_interval=2.0)


def _fullscreen_startup_view():
    view = _view3d()
    if view is None:
        return 0.2

    window, screen, area, region, space = view
...
bpy.app.timers.register(_setup_startup_view, first_interval=0.1)
...
def stop_osc_slice_dynamic() -> None:
    ...
    global _client, _server, _timer_running, _camera_initialized
